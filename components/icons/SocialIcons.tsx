...
export const YoutubeIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={iconClasses}>
        <path d="M12.04 4.8A5.25 5.25 0 0 0 6.79 10.05v3.9a5.25 5.25 0 0 0 5.25 5.25h0a5.25 5.25 0 0 0 5.25-5.25v-3.9a5.25 5.25 0 0 0-5.25-5.25ZM12.04 2.4a7.65 7.65 0 0 1 7.65 7.65v3.9a7.65 7.65 0 0 1-7.65 7.65h0a7.65 7.65 0 0 1-7.65-7.65v-3.9a7.65 7.65 0 0 1 7.65-7.65Zm-1.5 6.075 4.5 2.25-4.5 2.25v-4.5Z" />
    </svg>
);