...
const ImageGenerator: React.FC<ImageGeneratorProps> = ({ translations, language }) => {
    ...
    return (
        <section id="image-generation-section" className="mb-16 bg-surface-light dark:bg-surface-dark p-6 md:p-8 rounded-2xl border border-black/10 dark:border-white/10 shadow-lg">
            <h3 className="text-3xl font-bold text-center mb-2 font-heading uppercase tracking-wider bg-gradient-to-r from-amber-500 via-accent to-orange-600 bg-clip-text text-transparent">{translations.genTitle}</h3>
